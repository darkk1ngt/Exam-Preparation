// Okay now , let us populate a seed.js file that is meant to contain all inserts its basically meant to be soemthing like this but in relation to my schema . import bcrypt from 'bcrypt';
